...
# Turn off warnings for Getopts
local $^W;&Getopts('hnL:I:O:P:') || die $usage;
...
if ($opt_L eq "pcmc") {
	...
	print "n_ops: $n_ops, len_ops: $len_ops, n_flds: $n_flds, len_flds: $len_flds\n";
	print "n_masked_flds: $n_masked_flds, len_masked_flds: $len_masked_flds\n";
